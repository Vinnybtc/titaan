  ...
  return (
    <div>
      <div className="mb-10">
        ...
        <h1 className="text-3xl text-white font-light">Nieuw Project</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-transparent border border-white/10 text-white px-4 py-3 text-sm focus:border-gold/50 focus:outline-none transition-colors"
              placeholder="b.v. LUXE WONINGBOUW"
            />
          </div>
          <div>
            <label className="text-white/40 text-xs tracking-[0.2em] uppercase block mb-2">
        ...
        <div>
          ...
          <p className="text-white/20 text-xs mt-2">Of voer een URL in:</p>
          <input
            type="text"
            value={form.image}
