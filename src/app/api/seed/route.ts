...
export async function POST(req: Request) {
  ...
  try {
    ...
    const settings = [
      ...
      { key: "hero_subtitle", value: "Titaan Development is gespecialiseerd in het ontwikkelen en beheren van hoogwaardig vastgoed. Wij creëren duurzame waarde door strategische investeringen in premium locaties." },
      ...
      { key: "filosofie_card1_title", value: "Stedelijke Ontwikkeling" },
      { key: "filosofie_card1_desc", value: "Wij transformeren stedelijke gebieden door innovatieve herontwikkeling, waarbij we de balans bewaken tussen modern comfort en historisch karakter." },
      { key: "filosofie_card2_title", value: "Duurzame Waarde" },
      { key: "filosofie_card2_desc", value: "Onze projecten zijn ontworpen om blijvende waarde te creëren — zowel financieel als maatschappelijk — voor investeerders en gemeenschappen." },
      ...
      { key: "contact_heading", value: "Geïnteresseerd in samenwerking?" },
      { key: "contact_subtitle", value: "Neem contact met ons op voor meer informatie over onze projecten, investeringsmogelijkheden of een persoonlijk gesprek." },
